...
public class Board {
    ArrayList<Pair<Integer, Integer>> positionCoordinates; // for x, y coordinates
    ArrayList<Integer> snakeLadderPosition; // snake ladder position
    ...
    private void populatePositionCoordinates() {
        positionCoordinates.add(new Pair<>(0, 0)); // dummy coordinates
